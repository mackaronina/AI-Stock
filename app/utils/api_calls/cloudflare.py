...
async def generate_tags_for_image(img_data: str, prompt: str) -> list[str]:
    ...
    data = {
        'messages': [
            {
                'role': 'system',
                'content': f'This image was generated by the prompt "{prompt}". Generate a list of tags for the image. \
                The list must contain 1 to 10 tags. Each tag must begin with #. Try to avoid using tags that consist of \
                several words.'
            },
            {
                'role': 'user',
