...
TAGS_PROMPT = 'This image was generated by the prompt "{prompt}". Generate a list of tags for the image in json format. \
Json should consist of a "tags" field with a list of tags. The list must contain 1 to 10 tags. Each tag must begin with \
#. Try to avoid using tags that consist of several words.'
...
async def generate_tags_for_image(img_data: str, prompt: str) -> list[str]:
        ...
        'messages': [
            {
                ...
                'content': [
                    {
                        'type': 'text',
                        'text': TAGS_PROMPT.format(prompt=prompt)
                    },
                    {
                        'type': 'image_url',
                        'image_url': {
